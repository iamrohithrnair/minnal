# minnal mobile design spec

This concept is derived from the current native iOS client in:

- `ios/Sources/MinnalMobile/Theme.swift`
- `ios/Sources/MinnalMobile/ContentView.swift`
- `docs/IOS_CLIENT.md`

## Product framing

minnal mobile is not a terminal emulator. It is a touch-first remote control and conversation surface for a minnal server running on a developer’s laptop or desktop.
...
- `minnal-mobile-plugin/` generates editable screens directly in Figma
- `minnal-mobile-mockup.svg` gives a fast importable preview
