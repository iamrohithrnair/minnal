# minnal Mobile Screens plugin

A tiny development plugin for Figma that creates editable mock screens for the current minnal iOS app concept.
...
5. Run **Plugins → Development → minnal Mobile Screens**
