...
use minnal_message_types::{ContentBlock, Message, Role, ToolCall};
...
pub struct EnvSnapshot {
    ...
    pub provider: String,
    pub model: String,
    pub minnal_version: String,
    pub minnal_git_hash: Option<String>,
    pub minnal_git_dirty: Option<bool>,
    pub os: String,
    pub arch: String,
    pub pid: u32,
    pub is_selfdev: bool,
...
pub struct SessionSearchReport {
    ...
    pub scanned_minnal_sessions: usize,
    pub candidate_minnal_sessions: usize,
...
pub fn format_session_search_results(
    ...
    output.push_str(&format!(
        "_Scanned: {} Minnal sessions ({} candidates), {} external sessions{}{}._\n\n",
        report.scanned_minnal_sessions,
        report.candidate_minnal_sessions,
