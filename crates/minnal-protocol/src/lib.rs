//! Client-server protocol for minnal
//!
...
use minnal_batch_types::BatchProgress;
use minnal_message_types::{InputShellResult, ToolCall};
use minnal_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use minnal_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = minnal_selfdev_types::ReloadRecoveryDirective;
...
pub enum Request {
    ...
    SetCompactionMode {
        id: u64,
        mode: minnal_config_types::CompactionMode,
    },
    ...
    /// Query minnal agent's capabilities
...
pub enum ServerEvent {
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        images: Vec<minnal_session_types::RenderedImage>,
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<minnal_provider_core::ModelRoute>,
        ...
        #[serde(default)]
        compaction_mode: minnal_config_types::CompactionMode,
