...
pub struct AuthConfig {
    /// External auth source ids that the user has approved minnal to read/use.
...
pub struct ProviderConfig {
    ...
    /// Whether minnal should automatically try another account on the same provider
...
pub struct SafetyConfig {
    ...
    /// SMTP password (prefer MINNAL_SMTP_PASSWORD env var)
