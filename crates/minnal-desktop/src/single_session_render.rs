...
pub(crate) fn desktop_header_version_label() -> String {
    let version = option_env!("MINNAL_DESKTOP_VERSION").unwrap_or(env!("CARGO_PKG_VERSION"));
...
pub(crate) fn fresh_welcome_version_label() -> String {
    let version = option_env!("MINNAL_PRODUCT_VERSION")
        .or(option_env!("MINNAL_DESKTOP_VERSION"))
        .unwrap_or(env!("CARGO_PKG_VERSION"));
    format!("minnal {version}")
}
