...
fn main() {
    ...
    println!("cargo:rustc-env=MINNAL_DESKTOP_VERSION={version}");
    println!("cargo:rustc-env=MINNAL_PRODUCT_VERSION={product_version}");
    println!("cargo:rustc-env=MINNAL_DESKTOP_GIT_HASH={git_hash}");
