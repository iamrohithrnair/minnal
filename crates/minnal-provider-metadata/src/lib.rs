...
pub const OPENAI_COMPAT_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    setup_url: "https://github.com/iamrohithrnair/minnal#openai-compatible-providers",
    default_model: None,
    requires_api_key: true,
};
...
pub const CLAUDE_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    ...
    aliases: &["anthropic"],
    menu_detail: "official Anthropic API key",
    recommended: true,
...
pub const MINNAL_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "minnal",
    display_name: "Minnal Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::Minnal,
    auth_status_method: "API key",
    aliases: &["subscription", "minnal-subscription"],
    menu_detail: "curated minnal subscription models",
    recommended: false,
    target: LoginProviderTarget::Minnal,
