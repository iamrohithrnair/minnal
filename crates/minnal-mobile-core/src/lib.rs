...
impl Default for PairingForm {
    fn default() -> Self {
        Self {
            ...
            device_name: "minnal simulator".to_string(),
        }
    }
}
        ...
        match scenario {
            ...
            ScenarioName::ToolApprovalRequired => {
                ...
                state.messages.push(ChatMessage {
                    ...
                    text: "Tool approval required: bash: cargo test -p minnal-mobile-core."
                        .to_string(),
                });
    ...
    pub fn dispatch(&mut self, action: SimulatorAction) -> DispatchReport {
        ...
        while let Some(action) = pending.pop() {
            ...
            for effect in reduction.effects {
                ...
                let follow_ups = FakeMinnalBackend::default().handle_effect(effect);
...
pub struct FakeMinnalBackend;

impl FakeMinnalBackend {
