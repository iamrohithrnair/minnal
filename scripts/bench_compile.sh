...
Targets:
  ...
  release-minnal    Run scripts/dev_cargo.sh build --release -p minnal --bin minnal --quiet
  selfdev-minnal    Run scripts/dev_cargo.sh build --profile selfdev -p minnal --bin minnal --quiet
...
Examples:
  ...
  scripts/bench_compile.sh release-minnal --json
  scripts/bench_compile.sh selfdev-minnal --json
USAGE
}
...
case "$target" in
  ...
  build)
    ...
    ;;
  release-minnal)
    cmd=(scripts/dev_cargo.sh build --release -p minnal --bin minnal --quiet)
    ;;
  selfdev-minnal)
    cmd=(scripts/dev_cargo.sh build --profile selfdev -p minnal --bin minnal --quiet)
    ;;
  *)
