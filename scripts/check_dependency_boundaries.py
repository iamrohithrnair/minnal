...
small: it blocks direct dependencies from any `minnal-*-types` crate to root or
...
FORBIDDEN_INTERNAL_DEPS = {
    ...
    "minnal-provider-gemini",
    "minnal-provider-metadata",
    "minnal-provider-openrouter",
    "minnal-protocol",
...
def is_type_crate(name: str) -> bool:
    return name.startswith("minnal-") and name.endswith("-types")
