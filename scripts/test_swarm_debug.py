...
SOCKET_PATH = f"/run/user/{os.getuid()}/minnal-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/minnal.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure minnal server is running with debug control enabled.")
