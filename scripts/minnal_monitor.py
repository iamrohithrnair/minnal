#!/usr/bin/env python3
"""
minnal Live Monitor - Real-time activity dashboard

Connects to minnal's debug socket and displays live streaming events.
Run minnal serve in one terminal, then this monitor in another.

Usage: ./minnal_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the minnal debug socket path"""
