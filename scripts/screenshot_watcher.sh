#!/bin/bash
# Screenshot Watcher - monitors for minnal screenshot signals
#
# This script watches the signal directory and captures screenshots
# when minnal signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start minnal with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/minnal-screenshots"
...
echo "Enable in minnal with: /screenshot-mode on"
echo ""
