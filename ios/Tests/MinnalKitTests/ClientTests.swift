...
func runClientTests() {
    ...
    do {
        ...
        assertEqual2(decoded.serverName, "minnal")
    ...
    do {
        print("  MinnalConnection URL/auth header wiring...")
        let connection = MinnalConnection(host: "example.com", port: 7643, authToken: "abc123")
