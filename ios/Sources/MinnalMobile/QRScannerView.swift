...
struct QRScannerView: View {
        ...
        NavigationStack {
            ZStack {
                ...
                if cameraPermissionGranted {
                    QRCameraView { uri in
                        if let parsed = parseMinnalURI(uri) {
                    ...
                    .overlay(alignment: .bottom) {
                        VStack(spacing: JC.Spacing.sm) {
                            ...
                            Text("Point at the QR code from **minnal pair**")
    ...
    private func parseMinnalURI(_ string: String) -> (host: String, port: UInt16, code: String)? {
