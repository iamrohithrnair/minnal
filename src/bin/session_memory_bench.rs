...
use minnal::message::{ContentBlock, Role};
use minnal::process_memory;
use minnal::session::Session;
...
fn main() -> anyhow::Result<()> {
    ...
    let display_messages = minnal::tui::display_messages_from_session(&session);
    ...
    let client_memory = minnal::tui::transcript_memory_profile(
        &session,
