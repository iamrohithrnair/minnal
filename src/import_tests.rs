...
#[test]
fn test_import_pi_session_creates_minnal_snapshot() {
    let _guard = crate::storage::lock_test_env();
    let temp = tempfile::TempDir::new().unwrap();
    let _home = EnvVarGuard::set_path("MINNAL_HOME", temp.path());
...
#[test]
fn test_import_opencode_session_creates_minnal_snapshot() {
    let _guard = crate::storage::lock_test_env();
    let temp = tempfile::TempDir::new().unwrap();
    let _home = EnvVarGuard::set_path("MINNAL_HOME", temp.path());
...
#[test]
fn test_resolve_resume_target_to_minnal_imports_codex_session() {
    let _guard = crate::storage::lock_test_env();
    let temp = tempfile::TempDir::new().unwrap();
    let _home = EnvVarGuard::set_path("MINNAL_HOME", temp.path());
    ...
    let resolved =
        resolve_resume_target_to_minnal(&crate::tui::session_picker::ResumeTarget::CodexSession {
    ...
    assert_eq!(
        resolved,
        crate::tui::session_picker::ResumeTarget::MinnalSession {
