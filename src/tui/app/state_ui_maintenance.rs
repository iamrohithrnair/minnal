            ...
            crate::bus::ClientMaintenanceAction::Update => {
                ...
                self.set_client_maintenance_message(
                    ...
                    Self::client_maintenance_card_message(
                        ...
                        "Running in the background. minnal will reload automatically when the update is ready.",
                    ),
                );
            ...
            crate::bus::ClientMaintenanceAction::Rebuild => {
                ...
                self.set_client_maintenance_message(
                    ...
                    Self::client_maintenance_card_message(
                        ...
                        "Running in the background. minnal will reload automatically after the rebuild succeeds.",
                    ),
                );
    ...
    pub(super) fn maybe_finish_background_client_reload(&mut self) -> bool {
        ...
        self.set_client_maintenance_message(
            ...
            Self::client_maintenance_card_message(
                action,
                "reloading client",
                "The new binary is ready, so minnal is switching over now.",
            ),
        );
            ...
            SessionUpdateStatus::Status {
                ...
                self.set_client_maintenance_message(
                    ...
                    Self::client_maintenance_card_message(
                        action,
                        message,
                        "Still running in the background. minnal will reload automatically when ready.",
                    ),
                );
            }
