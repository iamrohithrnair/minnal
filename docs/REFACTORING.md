...
This document defines the safe, incremental path for refactoring minnal while preserving behavior.
...
- Compile timing: `scripts/bench_compile.sh check --runs 3 --touch <hot-file>` and `scripts/bench_compile.sh release-minnal --runs 3`
