...
- Convert MCP tools to minnal Tool trait
...
2. minnal spawns the process, does MCP handshake
...
**Initialize:**
```json
{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"minnal","version":"0.1.0"}}}
```
